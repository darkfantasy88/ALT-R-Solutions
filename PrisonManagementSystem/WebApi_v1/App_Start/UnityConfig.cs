...
namespace WebApi_v1
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            #region Visit Dependecy Management
            container.RegisterType<IVisitDataAccess, VisitDataAccess>();
            container.RegisterType<FamilyFriendsVisit>();
            container.RegisterType<OtherVisit>();
            container.RegisterType<SchoolVisit>();
